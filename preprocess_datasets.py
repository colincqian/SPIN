...
"""
import os
os.environ["CDF_LIB"] = '/local/home/chqian/Downloads/cdf38_0-dist-all/cdf38_0-dist/lib'
import argparse
...
parser.add_argument('--my_eval_files', default=False, action='store_true', help='Extract files needed for evaluation')
...
if __name__ == '__main__':
    ...
    if args.my_eval_files:

        pw3d_extract(cfg.MY_3DP_ROOT, 'data/my_3DP')
